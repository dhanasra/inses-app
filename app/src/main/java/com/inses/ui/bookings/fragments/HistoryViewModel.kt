...
class HistoryViewModel @Inject constructor(context:Context):BaseViewModel<MyBookingsNavigator>() {
    ...
    fun makeService(){
        viewModelScope.launch {
            ...
            val getDeferredUserDetails = ApiService.AppApi.retrofitService.getBookingHistory(requestBody)
            try {
