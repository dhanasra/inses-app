...
class ProfileViewModel @Inject constructor(context: Context):BaseViewModel<ProfileNavigator>() {
    ...
    fun sendFeedback(){
        viewModelScope.launch {
            ...
            val getDeferredUserDetails = ApiService.AppApi.retrofitService.addFeedback(requestBody)
            try {
